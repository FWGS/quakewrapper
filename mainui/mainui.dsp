...
# Begin Custom Build
TargetDir=\Quake\ID1\src_main\temp\mainui\!release
InputPath=\Quake\ID1\src_main\temp\mainui\!release\menu.dll
SOURCE="$(InputPath)"

"D:\Quake\ID1\bin\menu.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\menu.dll "D:\Quake\ID1\bin\menu.dll"
...
# Begin Custom Build
TargetDir=\Quake\ID1\src_main\temp\mainui\!debug
InputPath=\Quake\ID1\src_main\temp\mainui\!debug\menu.dll
SOURCE="$(InputPath)"
